        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/mansur.PNG'); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs">Selamat Datang, mansur <?php echo $guru; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('assets/mansur.PNG'); ?>" class="img-circle" alt="User Image">

                <p>
                  mansur, <?php echo $guru; ?>
